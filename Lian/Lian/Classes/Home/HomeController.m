...
-(void)loadTitlesViewInfo{
    ...
    //网络请求地址
    NSString *url=[NSString stringWithFormat:@"%@",@"http://api.dantangapp.com/v2/channels/preset?gender=1&generation=1"];
    //发送网络请求
...
- (void)setUpTitles
{
    ...
    for (NSInteger i = 0; i < count; i++) {
        ...
        Channels *channel = self.channels[i];
 ...
 *  添加子控制器
 */
- (void)addChildVc:(Channels *)channel {
